...
export default class PractQuizattemptscreen extends Component {
  state = {
    collapsed: false,
    apiData: [],
  ...
  componentDidMount() {
    ...
    if (token) {
      fetch(`${ROOT}dashboardAnalytics/attemptcount/?practice=true`, {
        method: 'GET',
        headers: {
            ...
            <div className="container-1">
              <Row gutter={[16, 16]}>
                <Col style={{marginLeft:180}} span={18}>
                  ...
                  >
                    <Quizattempt  data={this.state.apiData} />
                  </Card>
                </Col>
              </Row>
            </div>
